...
-- =============================================================================
-- Staff users so the planner CRM + the option-rate CMS can be exercised live:
--   superadmin@jingdezhen.test  (super_admin)      — id ...005  (bypasses RBAC)
--   planner@jingdezhen.test      (travel_planner)   — id ...003
--   cs@jingdezhen.test           (customer_service)  — id ...004
-- All carry password "password123" (hash reused from the customer seed).
...
DELETE FROM user_roles WHERE user_id IN ('00000000-0000-0000-0000-000000000005','00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000004');

INSERT INTO user_roles (user_id, role_id)
SELECT '00000000-0000-0000-0000-000000000005', id FROM roles WHERE key = 'super_admin'
