...
func (h *Handler) adminTransition(c *fiber.Ctx, to models.ContentStatus) error {
	...
	if act := audit.ActionForTransition(to); act != "" {
		h.audit.Log(c, act, models.AuditEntityProduct, strconv.FormatInt(id, 10), map[string]any{"locale": body.Locale, "to": string(to)})
	}
	return c.Status(fiber.StatusOK).JSON(product)
}
...
func (h *Handler) AdminDeleteProduct(c *fiber.Ctx) error {
	...
	h.audit.Log(c, models.AuditActionProductDelete, models.AuditEntityProduct, strconv.FormatInt(id, 10), nil)
...
func (h *Handler) AdminDeleteSKU(c *fiber.Ctx) error {
	...
	h.audit.Log(c, models.AuditActionSKUDelete, models.AuditEntitySKU, strconv.FormatInt(skuID, 10), nil)
	return c.SendStatus(fiber.StatusNoContent)
}
