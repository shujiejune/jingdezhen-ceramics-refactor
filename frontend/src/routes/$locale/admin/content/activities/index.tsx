...
export const Route = createFileRoute('/$locale/admin/content/activities/')({
...
function ActivitiesListPage() {
  ...
  useEffect(() => {
    ...
    setList(null)
    api
      .adminListActivities(token, locale)
  ...
  const columns: Column<Activity>[] = [
    {
      ...
      cell: (row) => (
        <DetailLinkCell to={`/${locale}/admin/content/activities/${row.id}`} label={row.title} />
      ),
    },
